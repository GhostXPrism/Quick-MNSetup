#!/bin/bash
# GhostPrismCoin Masternode Setup Script V1 for Ubuntu 18.04 LTS
#
...
wget https://github.com/GhostXPrism/GhostPrism-Coin/releases/download/v1.0/Ghost-Deamon_Ubuntu1804.tar.gz
tar -xzvf Ghost-Deamon_Ubuntu1804.tar.gz
